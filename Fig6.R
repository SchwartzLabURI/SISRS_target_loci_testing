...
t <- ggtree(rooted_tree, layout="rectangular", size=1) + xlim(0, 3.4) + 
  annotate("point", x=0, y=80, shape=21, fill="darkgray", color="black", size=3) + 
  annotate("text", x=0.05, y=80, label = "> 75% node support", hjust = "left") + 
...
ggsave(plot = t2, filename = "SCG_SpeciesTree_supercontigs_astral3.png", width = 15, height = 15, units = "in", limitsize = FALSE)
