...
geom_cladelab(node=183, label="Brevilimbatids", family="Helvetica", fontface="plain", offset=1.25) + 
geom_cladelab(node=203, label="Burmeisterids", family="Helvetica", fontface="plain", offset=1) + 
geom_cladelab(node=181, label="giganteus grade", family="Helvetica", fontface="plain", offset=1.59) + 
geom_cladelab(node=173, label="Peruvianids", family="Helvetica", fontface="plain", offset=1.44) + 
geom_cladelab(node=231, label="Eucentropogonids", family="Helvetica", fontface="plain", offset=1.28) + 
geom_cladelab(node=140, label="andinus clade", family="Helvetica", fontface="plain", offset=1.44) + 
geom_cladelab(node=155, label="Colombianids", family="Helvetica", fontface="plain", offset=1.24)
t2
dev.off()
