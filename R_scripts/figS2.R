...
pdf("353_SCG_SpeciesTree_supercontigs_TargetCapture_astral3.pdf", width=9, height=9)
...
geom_cladelab(node=108, label="Brevilimbatids", family="Helvetica", fontface="plain", offset=1.02) + 
geom_cladelab(node=130, label="Burmeisterids", family="Helvetica", fontface="plain", offset=0.76) + 
geom_cladelab(node=129, label="giganteus grade", family="Helvetica", fontface="plain", offset=1.41) + 
geom_cladelab(node=101, label="Peruvianids", family="Helvetica", fontface="plain", offset=1.34) + 
geom_cladelab(node=184, label="Eucentropogonids", family="Helvetica", fontface="plain", offset=0.93) + 
geom_cladelab(node=164, label="andinus clade", family="Helvetica", fontface="plain", offset=0.995) + 
geom_cladelab(node=144, label="Colombianids", family="Helvetica", fontface="plain", offset=0.7)
t2
dev.off()
