...
setwd("/Users/corinna/Documents/Work/Schwartz_Lab/Campanulaceae/TargetCapture/SISRS")
...
pdf("SISRS_SCG_SpeciesTree_TargetCapture_astral3.pdf", width=9, height=11)
t <- ggtree(rooted_tree, layout="rectangular", size=1) + 
geom_treescale(x=0, y=120) + xlim(0, 13) + 
...
geom_cladelab(node=177, label="Brevilimbatids", family="Helvetica", fontface="plain", offset=4.57) + 
geom_cladelab(node=197, label="Burmeisterids", family="Helvetica", fontface="plain", offset=2) + 
geom_cladelab(node=175, label="giganteus grade", family="Helvetica", fontface="plain", offset=7.65) + 
geom_cladelab(node=167, label="Peruvianids", family="Helvetica", fontface="plain", offset=6.26) + 
geom_cladelab(node=147, label="Eucentropogonids", family="Helvetica", fontface="plain", offset=2.84) + 
geom_cladelab(node=126, label="andinus clade", family="Helvetica", fontface="plain", offset=3.8) + 
geom_cladelab(node=228, label="Colombianids", family="Helvetica", fontface="plain", offset=4.7)
t2
dev.off()
